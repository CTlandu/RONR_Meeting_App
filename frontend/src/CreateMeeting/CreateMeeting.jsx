    ...
    <div className="flex justify-center items-center h-screen bg-gray-200">
      ...
      <div className="w-2/5 bg-gray-400 p-10 rounded-lg border-4 border-gray-300">
        ...
        <div className="text-left mb-8">
          <button className="bg-gray-600 text-black font-bold py-2 px-4 rounded">
        ...
        <div className="flex justify-center mt-8 space-x-8">
          <button onClick={() => window.location.href='/chooserole'} className="bg-green-500 text-black font-bold py-2 px-10 rounded-lg">CONFIRM</button>
          <button onClick={() => window.location.href='/profile'} className="bg-red-400 text-black font-bold py-2 px-10 rounded-lg">CANCEL</button>
        </div>
      </div>
    </div>
  );
